...
priors = data.frame(scenario=c("1. Alive+Duke", "2. Dead+Duke", "3. Dead+Count"), probability=c(0, 0.5, 0.5))
posteriors = data.frame(scenario=c("1. Alive+Duke", "2. Dead+Duke", "3. Dead+Count"), probability=c(0, 1, 0))
...
ggsave(file="~/Downloads/reallocation-of-probabilities-2.svg", g, width=8, height=4, units="in", device="svg", dpi=75, bg="transparent")
